          ...
          <div className="flex flex-wrap gap-6 ">
            ...
            <div className="flex items-center  gap-2">
              <input
                ...
                max="1000000"
                required
                className="rounded-lg border border-gray-300 p-3 w-24 "
                onChange={handleChange}
        ...
        <div className="flex flex-col flex-1 gap-2">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="uppercase border border-green-700 p-3 rounded hover:shadow-lg disabled:opacity-80 "
            >
          ...
          <button
            ...
            className="uppercase p-3 bg-slate-700 rounded-lg text-white disabled:opacity-80"
          >
